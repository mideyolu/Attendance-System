...
#         avg_score = best_score / frames_used if frames_used > 0 else 0

#         confidence_percent = round(avg_score, 2)
#         margin_percent = round((best_score - second_score) / len(images) * 100, 2)

#         user_data = next(
#             (u for u in face_service.id_map if u["regno"] == best_regno), None
#         )
